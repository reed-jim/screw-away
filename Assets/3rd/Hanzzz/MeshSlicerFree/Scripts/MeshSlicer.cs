...
namespace Hanzzz.MeshSlicerFree
{
    ...
    public class MeshSlicer
    {
        ...
        public (GameObject, GameObject) Slice(GameObject targetGameObject, (Vector3, Vector3, Vector3) slicePlane, Material intersectionMaterial)
        {
            ...
            slicedMesh.Item1.name = $"{targetGameObject.name} - Sliced 1";
            slicedMesh.Item2.name = $"{targetGameObject.name} - Sliced 2";

#if UNITY_EDITOR
            AssetDatabase.CreateAsset(slicedMesh.Item1, $"Assets/Models/Screw Away/{slicedMesh.Item1.name}.asset");
            AssetDatabase.CreateAsset(slicedMesh.Item2, $"Assets/Models/Screw Away/{slicedMesh.Item2.name}.asset");
